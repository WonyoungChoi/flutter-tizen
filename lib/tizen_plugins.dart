    ...
    internal class GeneratedPluginRegistrant
    {
      ...
      {{/nativePlugins}}
        ...
        public static void RegisterPlugins(IPluginRegistry registry)
        {
          ...
          {{/nativePlugins}}
          {{#dotnetPlugins}}
            registry.RegisterPlugin(new global::{{namespace}}.{{pluginClass}}());
          {{/dotnetPlugins}}
        }
    }
}
...
void _writeIntermediateDotnetFiles(
  ...
  renderTemplateToFile(
    ...
    context,
    project.intermediateDirectory.childFile('Runner.csproj.flutter.props'),
  );
  renderTemplateToFile(
    _intermediateDotnetTargetsTemplate,
    context,
    project.intermediateDirectory.childFile('Runner.csproj.flutter.targets'),
  );
}
